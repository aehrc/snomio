...
public class Node {
  ...
  /**
   * Comparator for sorting nodes in a product model into an order of least dependent on new concept
   * to most dependent on new concept.
   *
   * <p>Concepts should not be dependent on each other, and this method will throw an exception if
   * it encounters a cycle.
   *
   * @return Comparator for sorting nodes in a product model into an order of least dependent on new
   *     concepts
   */
  public static Comparator<@Valid Node> getNodeReferenceComparator() {
    return (o1, o2) -> {
