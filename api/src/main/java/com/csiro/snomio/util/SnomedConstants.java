...
public enum SnomedConstants implements SnomioConstants {
  ...
  DEFINED("900000000000073002","Sufficiently defined by necessary conditions definition status (core metadata concept)"),
  PRIMITIVE("900000000000074008","Not sufficiently defined by necessary conditions definition status (core metadata concept)"),
  SOME_MODIFIER("900000000000450001","Modifier (core metadata concept)"),
  STATED_RELATIONSHUIP_CHARACTRISTIC_TYPE("900000000000010007","Stated relationship (core metadata concept)"),
  ...
  CONTAINERIZED_BRANDED_CLINICAL_DRUG_PACKAGE_SEMANTIC_TAG("containerized branded clinical drug package"),
  ...
  private SnomedConstants(String value) {
    this.value = value;
    this.label = null;
  }

  private SnomedConstants(String value, String label) {
    this.value = value;
    this.label = label;
  }
