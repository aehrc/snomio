...
@NamedNativeQuery(
    ...
    query = "select a2_0.id typeId,a2_0.name typeName,string_agg(cast(a1_0.id as text),',') valueIds,a1_0.value_of value from additional_field_value a1_0 join additional_field_type a2_0 on a2_0.id=a1_0.additional_field_type_id where a2_0.list_type=true group by a2_0.id,a2_0.name,a1_0.value_of;",
