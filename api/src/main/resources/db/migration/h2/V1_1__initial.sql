...
create table additional_field_type_aud (rev integer not null, revtype tinyint, id bigint not null, description varchar(255), name varchar(255), type varchar(255) check (type in ('DATE','NUMBER','STRING','LIST')), primary key (rev, id));
...
create table attachment_aud (length integer, rev integer not null, revtype tinyint, attachment_type_id bigint, id bigint not null, jira_created timestamp(6) with time zone, ticket_id bigint, description varchar(255), filename varchar(255), location varchar(255), sha256 varchar(255), thumbnail_location varchar(255), primary key (rev, id));
...
create table comment_aud (rev integer not null, revtype tinyint, id bigint not null, jira_created timestamp(6) with time zone, ticket_id bigint, text varchar(1000000), primary key (rev, id));
...
create table ticket_additional_field_values_aud (rev integer not null, revtype tinyint, additional_field_value_id bigint not null, ticket_id bigint not null, primary key (rev, additional_field_value_id, ticket_id));
...
create table ticket_aud (rev integer not null, revtype tinyint, id bigint not null, iteration_id bigint, priority_bucket_id bigint, state_id bigint, ticket_type_id bigint, description varchar(1000000), assignee varchar(255), title varchar(255), primary key (rev, id));
create table ticket_labels (label_id bigint not null, ticket_id bigint not null);
create table ticket_labels_aud (rev integer not null, revtype tinyint, label_id bigint not null, ticket_id bigint not null, primary key (rev, label_id, ticket_id));
