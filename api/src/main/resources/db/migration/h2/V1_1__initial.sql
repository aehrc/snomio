...
create table attachment (length integer, version integer, attachment_type_id bigint, created timestamp(6) with time zone not null, id bigint generated by default as identity, modified timestamp(6) with time zone, created_by varchar(255), description varchar(255), download_url varchar(255), filename varchar(255), location varchar(255), modified_by varchar(255), sha256 varchar(255), primary key (id));
create table attachment_aud (length integer, rev integer not null, revtype tinyint, attachment_type_id bigint, id bigint not null, description varchar(255), download_url varchar(255), filename varchar(255), location varchar(255), sha256 varchar(255), primary key (rev, id));
