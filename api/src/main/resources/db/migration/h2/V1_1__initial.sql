...
create table attachment_aud (length integer, rev integer not null, revtype tinyint, attachment_type_id bigint, id bigint not null, description varchar(255), filename varchar(255), location varchar(255), sha256 varchar(255), primary key (rev, id));
...
create table comment_aud (rev integer not null, revtype tinyint, id bigint not null, text varchar(1000000), primary key (rev, id));
...
create table task_association_aud (rev integer not null, revtype tinyint, id bigint not null, task_id varchar(255), primary key (rev, id));
...
create table ticket_attachments_aud (rev integer not null, revtype tinyint, attachment_id bigint not null, ticket_id bigint not null, primary key (rev, attachment_id, ticket_id));
...
create table ticket_comments_aud (rev integer not null, revtype tinyint, comment_id bigint not null, ticket_id bigint not null, primary key (rev, comment_id, ticket_id));
...
create table ticket_tasks_aud (rev integer not null, revtype tinyint, task_id bigint not null, ticket_id bigint not null, primary key (rev, task_id, ticket_id));
