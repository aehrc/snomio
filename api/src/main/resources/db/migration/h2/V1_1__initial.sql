...
create table attachment_aud (length integer, rev integer not null, revtype tinyint, attachment_type_id bigint, id bigint not null, ticket_id bigint, description varchar(255), filename varchar(255), location varchar(255), sha256 varchar(255), primary key (rev, id));
