create table additional_field (version integer, additional_field_type_value_id bigint, created timestamp(6) with time zone not null, id bigint generated by default as identity, modified timestamp(6) with time zone, ticket_id bigint, created_by varchar(255), modified_by varchar(255), primary key (id));
create table additional_field_aud (rev integer not null, revtype tinyint, additional_field_type_value_id bigint, id bigint not null, ticket_id bigint, primary key (rev, id));
...
create table comment_aud (rev integer not null, revtype tinyint, id bigint not null, ticket_id bigint, text varchar(255), primary key (rev, id));
...
create table ticket_additional_field_types (additional_field_type_value_id bigint not null, ticket_id bigint not null);
...
alter table if exists additional_field add constraint FKa0w02w3v4oikprja0wx601o4o foreign key (additional_field_type_value_id) references additional_field_type_value;
