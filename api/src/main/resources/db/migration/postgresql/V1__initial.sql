...
create table additional_field_type_additional_field_type_values_aud (rev integer not null, revtype smallint, additional_field_type_id bigint not null, additional_field_type_values_id bigint not null, primary key (rev, additional_field_type_id, additional_field_type_values_id));
...
create table additional_field_type_value_aud (grouping integer, rev integer not null, revtype smallint, additional_field_type_id bigint, id bigint not null, value_of varchar(255), primary key (rev, id));
create table attachment (length integer, version integer, attachment_type_id bigint, created timestamp(6) with time zone not null, id bigint generated by default as identity, modified timestamp(6) with time zone, ticket_id bigint, created_by varchar(255), description varchar(255), filename varchar(255), modified_by varchar(255), sha256 varchar(255), data oid, primary key (id));
create table attachment_aud (length integer, rev integer not null, revtype smallint, attachment_type_id bigint, id bigint not null, ticket_id bigint, description varchar(255), filename varchar(255), sha256 varchar(255), data oid, primary key (rev, id));
...
create table comment_aud (rev integer not null, revtype smallint, id bigint not null, ticket_id bigint, text varchar(100000), primary key (rev, id));
...
create table ticket_additional_field_types_aud (rev integer not null, revtype smallint, additional_field_type_value_id bigint not null, ticket_id bigint not null, primary key (rev, additional_field_type_value_id, ticket_id));
