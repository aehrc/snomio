...
create table label_type_aud (rev integer not null, revtype smallint, id bigint not null, description varchar(255), display_color varchar(255), name varchar(255), primary key (rev, id));
create table labels (label_type_id bigint not null, ticket_id bigint not null);
create table labels_aud (rev integer not null, revtype smallint, label_type_id bigint not null, ticket_id bigint not null, primary key (rev, label_type_id, ticket_id));
