...
create table additional_field_aud (rev integer not null, revtype smallint, additional_field_type_value_id bigint, id bigint not null, ticket_id bigint, primary key (rev, id));
