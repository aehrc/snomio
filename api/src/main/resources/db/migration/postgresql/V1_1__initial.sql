...
create table attachment_aud (length integer, rev integer not null, revtype smallint, attachment_type_id bigint, id bigint not null, ticket_id bigint, description varchar(255), download_url varchar(255), filename varchar(255), location varchar(255), sha256 varchar(255), primary key (rev, id));
...
create table comment_aud (rev integer not null, revtype smallint, id bigint not null, ticket_id bigint, text varchar(1000000), primary key (rev, id));
...
create table ticket_additional_field_values_aud (rev integer not null, revtype smallint, additiona_field_value_id bigint not null, ticket_id bigint not null, primary key (rev, additiona_field_value_id, ticket_id));
