...
create table additional_field_aud (rev integer not null, revtype tinyint, additional_field_type_id bigint, id bigint not null, ticket_id bigint, value_of varchar(255), primary key (rev, id));
...
create table label (version integer, created timestamp(6) with time zone not null, id bigint generated by default as identity, label_type_id bigint, modified timestamp(6) with time zone, ticket_id bigint, created_by varchar(255), modified_by varchar(255), primary key (id));
create table label_aud (rev integer not null, revtype tinyint, id bigint not null, label_type_id bigint, ticket_id bigint, primary key (rev, id));
create table label_type (version integer, created timestamp(6) with time zone not null, id bigint generated by default as identity, modified timestamp(6) with time zone, created_by varchar(255), description varchar(255), modified_by varchar(255), name varchar(255), primary key (id));
create table label_type_aud (rev integer not null, revtype tinyint, id bigint not null, description varchar(255), name varchar(255), primary key (rev, id));
create table label_type_label (label_id bigint not null unique, label_type_id bigint not null);
create table label_type_label_aud (rev integer not null, revtype tinyint, label_id bigint not null, label_type_id bigint not null, primary key (rev, label_id, label_type_id));
...
create table ticket (version integer, created timestamp(6) with time zone not null, id bigint generated by default as identity, modified timestamp(6) with time zone, state_id bigint, ticket_type_id bigint, created_by varchar(255), description varchar(255), modified_by varchar(255), title varchar(255), primary key (id));
...
create table ticket_aud (rev integer not null, revtype tinyint, created timestamp(6) with time zone, id bigint not null, modified timestamp(6) with time zone, state_id bigint, ticket_type_id bigint, created_by varchar(255), description varchar(255), modified_by varchar(255), title varchar(255), primary key (rev, id));
