...
create table label_type (version integer, created timestamp(6) with time zone not null, id bigint generated by default as identity, modified timestamp(6) with time zone, created_by varchar(255), description varchar(255), display_color varchar(255), modified_by varchar(255), name varchar(255), primary key (id));
create table label_type_aud (rev integer not null, revtype tinyint, id bigint not null, description varchar(255), display_color varchar(255), name varchar(255), primary key (rev, id));
create table labels (label_type_id bigint not null, ticket_id bigint not null);
create table labels_aud (rev integer not null, revtype tinyint, label_type_id bigint not null, ticket_id bigint not null, primary key (rev, label_type_id, ticket_id));
...
alter table if exists labels add constraint FKp5melsyu5xqsibdipx9tki38i foreign key (label_type_id) references label_type;
