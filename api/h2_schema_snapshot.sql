create table additional_field_type (version integer, created timestamp(6) with time zone not null, id bigint generated by default as identity, modified timestamp(6) with time zone, created_by varchar(255), description varchar(255), modified_by varchar(255), name varchar(255), primary key (id));
...
create table attachment_aud (length integer, rev integer not null, revtype tinyint, attachment_type_id bigint, id bigint not null, ticket_id bigint, data varchar(255), description varchar(255), sha256 varchar(255), primary key (rev, id));
...
create table task_association (id bigint generated by default as identity, ticket_id bigint, task_id varchar(255), primary key (id));
create table task_association_aud (rev integer not null, revtype tinyint, id bigint not null, ticket_id bigint, task_id varchar(255), primary key (rev, id));
