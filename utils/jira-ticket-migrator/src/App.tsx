...
import { Alert, Avatar, Box, Divider, LinearProgress, List, ListItem, ListItemAvatar, ListItemText, Typography } from '@mui/material'
                    ...
                    {tickets.map((ticket) => (
                        <React.Fragment key={ticket.id}>
                            <ListItem alignItems="flex-start">
                                <ListItemAvatar>
                                    <Avatar alt={ticket.fields.issuetype.name}  src={ticket.fields.issuetype.iconUrl} />
                                </ListItemAvatar>
                                <ListItemText
                                    primary={ticket.key}
                                    secondary={<React.Fragment>
                                        ...
                                        {ticket.fields.description}<br/>
                                        {ticket.fields.assignee != null ? ticket.fields.assignee.name : ''}
                                    </React.Fragment>} />
                            </ListItem>
